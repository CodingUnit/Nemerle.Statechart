...
"c:\Program Files\Nemerle\Net-4.0\Nemerle.Compiler.Test.exe" -ref:"tests\Nemerle.Statechart.dll" -ref:"tests\Nemerle.Statechart.Lib.dll" -ref:"tests\fsmtest.exe" -ref:"tests\Nemerle.Statechart.Runtime.dll" -ref:"tests\System.Reactive.Linq.dll" -ref:"tests\System.Reactive.Core.dll" -output:tests\ positive\*.n negative\*.n
pause
